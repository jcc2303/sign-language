import { i as env, q as squaredDifference, u as pow, v as maximum, w as minimum, g as sub, x as floorDiv, y as divNoNan, e as div, m as mul, z as mod, A as addN, d as add, B as prelu, C as leakyRelu, D as prod, E as rsqrt, F as clipByValue, G as tan, H as tanh, I as square, J as sqrt, K as softplus, L as sinh, M as sign, N as sin, j as sigmoid, O as selu, P as round, Q as relu, R as real, S as reciprocal, U as neg, V as imag, W as log1p, X as log, Y as floor, Z as expm1, _ as exp, $ as erf, a0 as elu, a1 as cosh, a2 as cos, a3 as complex, a4 as ceil, a5 as atanh, a6 as atan2, a7 as atan, a8 as asinh, a9 as asin, aa as acosh, ab as acos, ac as abs, ad as assert, ae as tensor, af as stack, ag as concat, ah as unstack, t as tidy, s as slice, ai as scalar, aj as maxPool3d, ak as avgPool3d, al as maxPoolWithArgmax, am as maxPool, an as avgPool, ao as conv3d, ap as depthwiseConv2d, aq as conv2dTranspose, ar as conv2d, as as depthwiseConv2d$1, at as conv2d$1, au as conv1d, av as zerosLike, aw as zeros, ax as truncatedNormal, ay as range, az as randomUniform, aA as onesLike, aB as ones, aC as oneHot, aD as multinomial, aE as linspace, aF as fill, aG as setdiff1dAsync, aH as whereAsync, aI as nonMaxSuppressionWithScoreAsync, aJ as nonMaxSuppressionAsync, aK as topk, c as tensor1d, o as cropAndResize, aL as resizeNearestNeighbor, aM as resizeBilinear, aN as where, aO as logicalOr, aP as logicalNot, aQ as logicalAnd, aR as lessEqual, aS as less, aT as greaterEqual, aU as greater, aV as notEqual, aW as equal, aX as matMul, aY as transpose, aZ as matMul$1, a_ as sparseToDense, a$ as logSoftmax, b0 as softmax, b1 as localResponseNormalization, b2 as batchNorm, b3 as cumsum, b4 as argMin, b5 as argMax, b6 as any, b7 as all, b8 as sum, b9 as min, ba as mean, bb as max, bc as gatherND, bd as scatterND, be as split$1, bf as tile, bg as arraysEqual, bh as stridedSlice, bi as reverse, bj as gather, bk as irfft, bl as rfft, bm as ifft, bn as fft, bo as broadcastTo, bp as depthToSpace, bq as batchToSpaceND, br as spaceToBatchND, bs as pad, r as reshape, bt as squeeze, bu as expandDims, bv as cast, bw as browserHTTPRequest, bx as getLoadHandlers, by as decodeWeights, bz as getSaveHandlers, T as Tensor } from './index-a0f0add6.js';
    ...
    switch (node.op) {
        ...
        case 'NonMaxSuppressionV2': {
            ...
            if (node.op === 'NonMaxSuppressionV5') {
                ...
                const result = await nonMaxSuppressionWithScoreAsync(boxes, scores, maxOutputSize, iouThreshold, scoreThreshold, softNmsSigma);
                return [result.selectedIndices, result.selectedScores];
            }
            return [await nonMaxSuppressionAsync(boxes, scores, maxOutputSize, iouThreshold, scoreThreshold)];
        }
        case 'Where': {
...
const executeOp$8 = (node, tensorMap, context) => {
    switch (node.op) {
        case 'ResizeBilinear': {
            ...
            return [resizeBilinear(images, [size[0], size[1]], alignCorners)];
        }
        case 'ResizeNearestNeighbor': {
            const images = getParamValue('images', node, tensorMap, context);
            const size = getParamValue('size', node, tensorMap, context);
            const alignCorners = getParamValue('alignCorners', node, tensorMap, context);
            return [resizeNearestNeighbor(images, [size[0], size[1]], alignCorners)];
        }
        case 'CropAndResize': {
            ...
            return [cropAndResize(image, boxes, boxInd, cropSize, method, extrapolationValue)];
        }
        default:
            throw TypeError(`Node type ${node.op} is not implemented`);
    }
...
const executeOp$d = (node, tensorMap, context) => {
    switch (node.op) {
        ...
        case 'SplitV': {
            ...
            return split$1(getParamValue('x', node, tensorMap, context), numOrSizeSplits, axis);
        }
        case 'ScatterNd': {
            const indices = getParamValue('indices', node, tensorMap, context);
...
const executeOp$f = (node, tensorMap, context) => {
    switch (node.op) {
        ...
        case 'PadV2':
        case 'Pad': {
            return [pad(getParamValue('x', node, tensorMap, context), split(getParamValue('padding', node, tensorMap, context), 2), getParamValue('constantValue', node, tensorMap, context))];
        }
        case 'SpaceToBatchND': {
...
export { GraphModel as G, deregisterOp as d, loadGraphModel as l, registerOp as r };
